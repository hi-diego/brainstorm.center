...
export default function Graph(props: GraphProps) {
  ...
  console.log(machine.context.notes);
  const tooltips = Notebook.notes.valueSeq().toArray().map(n => <Tooltip key={ n.title } note={ n } selected={ false }/>);
      // <div className="tooltips"> { tooltips } </div>
  return (
